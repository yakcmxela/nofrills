...
// Deregister old Jquery and get New. Load website scripts/styles enqueues.
	...
	function get_nofrills_scripts() {
		...
		wp_register_script('mapbox-js', 'https://api.mapbox.com/mapbox-gl-js/v0.42.0/mapbox-gl.js', array('jquery'), true);
	...
	function get_nofrills_styles() {
		...
		wp_enqueue_style('mapbox', 'https://api.mapbox.com/mapbox-gl-js/v0.42.0/mapbox-gl.css');
